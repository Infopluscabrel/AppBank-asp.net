...
namespace AppBank.Migrations
{
    ...
    [Migration("20211116133606_firstmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppBank.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("AppBank.Models.Bank.Transaction", b =>
                {
            ...
            modelBuilder.Entity("AppBank.Models.Customer", b =>
                {
                    b.Property<int>("CustomerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppBank.Models.Account", b =>
                {
                    b.HasOne("AppBank.Models.Customer", "CustomerAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("AppBank.Models.Bank.Transaction", b =>
                {
                    b.HasOne("AppBank.Models.Account", "AccountTransaction")
                        .WithMany()
